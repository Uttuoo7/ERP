...
const InventoryIssues = lazy(() => import('./pages/inventory/InventoryIssues').then(module => ({ default: module.InventoryIssues })));
const InventoryLedger = lazy(() => import('./pages/inventory/InventoryLedger').then(module => ({ default: module.InventoryLedger })));
const InventoryTurnover = lazy(() => import('./pages/inventory/InventoryTurnover').then(module => ({ default: module.InventoryTurnover })));
const InventoryClosingCertificate = lazy(() => import('./pages/inventory/InventoryClosingCertificate').then(module => ({ default: module.InventoryClosingCertificate })));
const InventoryConsumptionReport = lazy(() => import('./pages/inventory/InventoryConsumptionReport').then(module => ({ default: module.InventoryConsumptionReport })));
