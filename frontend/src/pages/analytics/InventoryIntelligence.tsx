    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 mt-1">Dead stock analysis, turnover rates, and holding costs.</p>
        </div>
      </div>
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden h-[500px] flex items-center justify-center">
        <div className="text-center text-slate-500">
          ...
          <h3 className="font-bold text-slate-700 text-lg">Inventory Data Warehouse</h3>
          <p className="text-sm mt-1">Loading aggregated inventory snapshots...</p>
        </div>
      </div>
    </div>
  );
